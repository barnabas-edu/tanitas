            ...
            <nav class="nav container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item">
                            <a href="/tanitas/tananyagok.html" class="nav__link">
                        ...
                        <li class="nav__item">
                            <a href="/tanitas/szamologep.html" class="nav__link">
						...
						<li class="nav__item">
                            <a href="/tanitas/rolam.html" class="nav__link">
...
class MyFooter extends HTMLElement {
	connectedCallback() {
		...
		<center><footer>
		<nav>
        <li><a href="/tanitas/index.html">Kezdőlap</a></li>
        <li><a href="/tanitas/altkem.html">Általános kémia</a></li>
        </nav></footer><center>
		`
	}
}
